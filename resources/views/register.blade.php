                ...
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body">
                            ...
                            <div class="auth-box">
                                ...
                                <form action="loginCon/get_user" method="post">
                                    @csrf
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center" value="sign_in" name="sbmt_login" />Sign up</button>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <a href="{{ url('/login') }}" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Sign in</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
