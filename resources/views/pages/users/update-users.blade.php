            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <form action="{{ url('/') }}/dashboard/users/update" method="post">
                        @csrf
                        <input type="hidden" name="id" id="id" value="{{ $user_data->id }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="email" id="email" class="form-control" placeholder="Email address" value="{{ $user_data->email }}" />
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        <input type="password" class="form-control pwd" id="login_password" placeholder="" name="password" value="{{ $user_data->password }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="checkbox" name="status" id="status" value="{{ $user_data->status }}" />
