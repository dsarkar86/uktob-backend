                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>Update User -- <small style="text-decoration: underline;"><?php echo $user['first_name'].' '.$user['last_name']; ?></small></h5>
                             ...
                             <div class="col-sm-8">
                               <?php echo form_open_multipart('administrator/update_user_data'); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                        <input type="date" id="dropper-default" value="<?php echo $user['dob']; ?>" name="dob" class="form-control" placeholder="Select Your Birth Date">
                                        </div>
                                    </div>
<!--                                     <div class="form-group row">
